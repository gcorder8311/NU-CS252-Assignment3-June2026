...
public:
    ...
    // Addition - permits code to run the correct destructor for Appointment
    virtual ~Appointment()
    {
    }
...
int main()
{
    ...
    // Addition - changed "you can use" to "recommend"
    cout << "Enter a date to check for appointments. (Recommend use 2026, 6, 14 to test code)" << endl;
    cout << "Year (e.g., 2026): ";
    cin >> searchYear;
    cout << "Month (1-12): ";
    cin >> searchMonth;
    ...
    // Addition - cleans up objects created with new to avoid a memory leak 
